...
def get_wall(
    ...
    response = requests.post(
        ...
        data={
            ...
            "access_token":  config.VK_CONFIG['537b0e534d2213c6c181a9f74511cedd1b9c49937adc1631bdce66712c0bb589f22cc79af53ea83b204d4'],
            "v": v
            }
    )
...
if __name__ == "__main__":
    wall = []
    for group in ['itmostudents', 'itmoru', 'world_of_tanks', 'wargaming', 'sportbox.ru', 'tproger']:
